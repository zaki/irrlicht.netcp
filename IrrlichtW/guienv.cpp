...
IntPtr GuiEnv_AddProgressBar(IntPtr guienv, bool horizontal, M_RECT rectangle, IntPtr parent, int id)
{
	return GetGui(guienv)->addProgressBar(horizontal, MU_RECT(rectangle), (IGUIElement*)parent, id);
}
