...
extern "C"
{
    ...
    EXPORT IntPtr SceneManager_AddTreeSceneNode(IntPtr scenemanager, M_STRING TreeXML, IntPtr parent, int id, M_VECT3DF position, M_VECT3DF rotation, M_VECT3DF scale, IntPtr TreeTexture, IntPtr LeafTexture, IntPtr BillTexture, int LeafMaterial);
