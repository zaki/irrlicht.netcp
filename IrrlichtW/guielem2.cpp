...
int GUIProgressBar_GetPos(IntPtr sb)
{
	return ((IGUIProgressBar*)sb)->getPos();
}

void GUIProgressBar_SetMax(IntPtr sb, int max)
{
	((IGUIProgressBar*)sb)->setMax(max);
}

void GUIProgressBar_SetPos(IntPtr sb, int pos)
{
	((IGUIProgressBar*)sb)->setPos(pos);
}

void GUIProgressBar_SetBackground(IntPtr sb, M_SCOLOR color)
{
	((IGUIProgressBar*)sb)->setBackground(MU_SCOLOR(color));
}

void GUIProgressBar_SetForeground(IntPtr sb, M_SCOLOR color)
{
	((IGUIProgressBar*)sb)->setForeground(MU_SCOLOR(color));
}
